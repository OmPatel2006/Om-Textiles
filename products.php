<?php
    ...
    $products_design1 = $dbconnect->prepare('SELECT * FROM products where id between 1 and 4');
    $products_design1->execute();
    $products_1 = $products_design1->fetchAll(PDO::FETCH_ASSOC);

    $products_design2 = $dbconnect->prepare('SELECT * FROM products where id between 5 and 8');
    $products_design2->execute();
    $products_2 = $products_design2->fetchAll(PDO::FETCH_ASSOC);

    $products_design3 = $dbconnect->prepare('SELECT * FROM products where id between 9 and 12');
    $products_design3->execute();
    $products_3 = $products_design3->fetchAll(PDO::FETCH_ASSOC);
        ...
        <main>
            <div class="products content-wrapper">
                ...
                <div class="categories">
                    ...
                    <a class="cat" href="category_Viacose_Jacquard.php"><button>Viscose Jacquard</button></a>
                </div>
                <br>
                <p><?=$total_products?> Products</p>
                <div class="products-wrapper">
                    <?php foreach ($products_1 as $product_1): ?>
                    <a href="index.php?page=product&id=<?=$product_1['id']?>" class="product">
                        <img src="Product Images/<?=$product_1['p_img']?>" width="200" height="200" alt="<?=$product_1['p_name']?>">
                        <span class="p_name"><?=$product_1['p_name']?></span>
                        <span class="price">
                            &#8377; <?=$product_1['price']?>
                        </span>
                    </a>
                ...
                <div class="products-wrapper">
                    <?php foreach ($products_2 as $product_2): ?>
                    <a href="index.php?page=product&id=<?=$product_2['id']?>" class="product">
                        <img src="Product Images/<?=$product_2['p_img']?>" width="200" height="200" alt="<?=$product_2['p_name']?>">
                        <span class="p_name"><?=$product_2['p_name']?></span>
                        <span class="price">
                            &#8377; <?=$product_2['price']?>
                        </span>
                    </a>
                ...
                <div class="products-wrapper">
                    <?php foreach ($products_3 as $product_3): ?>
                    <a href="index.php?page=product&id=<?=$product_3['id']?>" class="product">
                        <img src="Product Images/<?=$product_3['p_img']?>" width="200" height="200" alt="<?=$product_3['p_name']?>">
                        <span class="p_name"><?=$product_3['p_name']?></span>
                        <span class="price">
                            &#8377; <?=$product_3['price']?>
                        </span>
                    </a>
